...
--wait-for-files /work/frasergen/3D/work/shaojie/script/HiC/3d_model/.snakemake/tmp.ggvtexum /work/frasergen/3D/work/shaojie/script/HiC/3d_model/analysis20240419_3D_model/01.matrix_fill/AA --latency-wait 5 \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /work/frasergen/3D/work/shaojie/script/HiC/3d_model/.snakemake/tmp.ggvtexum/1.jobfinished || (touch /work/frasergen/3D/work/shaojie/script/HiC/3d_model/.snakemake/tmp.ggvtexum/1.jobfailed; exit 1)
