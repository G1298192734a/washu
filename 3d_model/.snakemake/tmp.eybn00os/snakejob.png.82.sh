#!/bin/sh
# properties = {"type": "single", "rule": "png", "local": false, "input": ["/work/frasergen/backup/3d/project/Interactome/240137_YanDanBaoJun_20240425/06.personal/analysis_3D_model_20240524/02.3d_model/TD_60MM12h/TD_60MM12h.pdb", "/work/frasergen/backup/3d/project/Interactome/240137_YanDanBaoJun_20240425/06.personal/analysis_3D_model_20240524/02.3d_model/TD_60MM12h/TD_60MM12h.pml"], "output": ["/work/frasergen/backup/3d/project/Interactome/240137_YanDanBaoJun_20240425/06.personal/analysis_3D_model_20240524/03.gif/TD_60MM12h/pngs/fig_210.png"], "wildcards": {"sample": "TD_60MM12h", "batch": "210"}, "params": {}, "log": [], "threads": 1, "resources": {"tmpdir": "/tmp"}, "jobid": 82, "cluster": {}}
 cd /work/frasergen/3D/work/shaojie/script/HiC/3d_model && \
/public/frasergen/PUB/software/python/Python-3.7.10/bin/python3 \
-m snakemake /work/frasergen/backup/3d/project/Interactome/240137_YanDanBaoJun_20240425/06.personal/analysis_3D_model_20240524/03.gif/TD_60MM12h/pngs/fig_210.png --snakefile /work/frasergen/3D/work/shaojie/script/HiC/3d_model/trid_model_snake.py \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /work/frasergen/3D/work/shaojie/script/HiC/3d_model/.snakemake/tmp.eybn00os/82.jobfinished || (touch /work/frasergen/3D/work/shaojie/script/HiC/3d_model/.snakemake/tmp.eybn00os/82.jobfailed; exit 1)
